...
[课程主页 giser.me](https://github.com/Jianghao/ucasgis/tree/gh-pages/) | [数据下载](https://github.com/Jianghao/ucasgis/tree/gh-pages/datasets_v7/) | [课件下载](https://github.com/Jianghao/ucasgis/tree/gh-pages/slides) 

# GIS 应用与实践课程
## 介绍
中国科学院大学资源与环境学院，2018年秋季学期，地理信息系统（GIS）应用实践AB，课程网站。
...
- **助教**
	...
	- 李  景 研究生 中国科学院大学资源与环境学院
	- 王卫锋 研究生 中国科学院大学资源与环境学院
...
- Chapter 6: [几何校正](https://github.com/Jianghao/ucasgis/raw/gh-pages/slides/chapter6.pptx)
- Chapter 9: [地图制图](https://github.com/Jianghao/ucasgis/raw/gh-pages/slides/chapter9.pdf)
- Chapter 15: [空间插值](https://github.com/Jianghao/ucasgis/raw/gh-pages/slides/chapter15.pdf)

## R语言脚本

- Chapter 15: [空间插值R语言实践](http://giser.me/script/chap15/spat_intp.html)，[工作目录(数据，源码)](https://github.com/Jianghao/ucasgis/tree/gh-pages/script/chap15/)


## 数据下载

数据目录：https://github.com/Jianghao/ucasgis/tree/gh-pages/datasets_v7/

---

<center> Copyright UCAS GIS, 2018. </center>